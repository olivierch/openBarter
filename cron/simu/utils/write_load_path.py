#!/usr/bin/python
## {{{ http://code.activestate.com/recipes/577172/ (r7)
"""
	write_path, load_path
"""
def write_path(path, text, encoding="utf-8", create_backup=False, log=None):
...
def load_path(path, encoding="utf-8", log=None):
...
## end of http://code.activestate.com/recipes/577172/ }}}
