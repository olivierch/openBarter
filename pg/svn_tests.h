...
#ifndef defined__svn_tests_h
#define defined__svn_tests_h
...
#define SVN_DECLARE_FCT(fct) svn_error_t *fct(const char **msg, bool msg_only, svn_test_opts_t *opts)
#define SVN_BEGIN_FCT(mssg) svn_error_t *err = SVN_NO_ERROR; \
	char buf[128]; \
	*msg = mssg; \
