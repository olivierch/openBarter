...
CREATE TYPE __flow_to_commits AS (num int8,qtt_r int8,nr int8,qtt_p int8,np int8);
COMMENT ON TYPE __flow_to_commits IS '(num int8,qtt_r int8,nr int8,qtt_p int8,np int8)';
