...
#define yyparse         yflow_yyparse
#define yylex           yflow_yylex
#define yyerror         yflow_yyerror
#define yylval          yflow_yylval
#define yychar          yflow_yychar
#define yydebug         yflow_yydebug
#define yynerrs         yflow_yynerrs
...
{
       0,     0,     3,     6,    10,    12,    16,    20,    22
};

/* YYRHS -- A `-1'-separated list of the rules' RHS.  */
static const yytype_int8 yyrhs[] =
{
      10,     0,    -1,     5,     6,    -1,     5,    11,     6,    -1,
      12,    -1,    11,     7,    12,    -1,     3,    13,     4,    -1,
       8,    -1,    13,     7,     8,    -1
};
...
{
  "$end", "error", "$undefined", "O_PAREN", "C_PAREN", "O_BRACKET",
  "C_BRACKET", "COMMA", "FLOWINT", "$accept", "box", "bid_list", "bid",
  "list", 0
};
#endif
